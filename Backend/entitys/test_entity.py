...
# Pliki lokalne
from datamodel import (CallbackMessageType, UUID_Test_t, ID_Pytanie_t, 
...
class Test:
    def __init__(self, ID: UUID_Test_t,
        ...
        self._callbackRegister: CallbackRegister = callbackRegister if callbackRegister else CallbackRegister()
    ...
    def getWyniki(self) -> list[UczenWynikResponse]:
    ...
    def getInfo(self) -> TestInfoResponse:
        return TestInfoResponse(ID=self._ID, zamkniety=self._zamkniety, 
                                ...
                                uczestnicy_odpowiedzi=self.getWyniki())
    
    def __str__(self) -> str:
        return (f"Test(ID={self._ID}, zamkniety={self._zamkniety}")
    
    def usun(self) -> None:
        self._callbackRegister.powiadom(CallbackMessageType.DELETE, self.getInfo())
        self._callbackRegister.wyczysc()
       
    def zamknij(self) -> None:
        self._zamkniety = True
            
    def otworz(self) -> None:
        self._zamkniety = False
    
    def reset(self) -> None:
        self.otworz()
        self._uczestnicy.clear()
    ...
    def odp_uzytkownika(self, uczestnik: Uczestnik) -> TestWynikResponse:
        ...
        self._callbackRegister.powiadom(CallbackMessageType.UPDATE, self.getInfo())
